...
func test_equipment_init():
	...
	var item = Equipment.new("Test Tunic", Equipment.Slot.TUNIC, stats, Equipment.Rarity.RARE)
	...
	assert_eq(item.rarity, Equipment.Rarity.RARE, "Rarity should be set correctly")
